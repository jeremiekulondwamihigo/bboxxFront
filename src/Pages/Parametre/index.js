...
function Parametre() {
  ...
  const handleFile = (e) => {
    ...
    if (selectedFile) {
      if ((selectedFile && fileType[0].includes(selectedFile.type)) || (selectedFile && fileType[1].includes(selectedFile.type))) {
  ...
  return (
    <div>
      ...
      <form className="form-group" autoComplete="off" onSubmit={handleSubmit}>
        ...
        <Grid container>
          <Grid item lg={7} className="col-lg-7">
            <Input type="file" className="form-control" required accept=".xls, .xlsx" onChange={handleFile} />
          </Grid>
          <Grid item lg={5}>
            ...
            <Button color="primary" variant="contained" onClick={() => sendData()} sx={{ marginLeft: '10px' }}>
              Envoyer
            </Button>
          </Grid>
        </Grid>
